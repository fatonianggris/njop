var app = function () {
        ...
        function v(o) {
            ...
            o || (b.group = it,
                    ...
                    u ? d = b : (x && (w(),
                        ...
                        if (d && t > d.start && (u = y(d, s),
                                d = null,
                                nt(n, u.b, "start"),
                                x && (w(),
                                        f = R(n, c, u.b, u.duration, 0, l, a.css))),
                                u)
                            if (t >= u.end)
                                v(c = u.b, 1 - c),
                                        nt(n, u.b, "end"),
                                        d || (u.b ? w() : --u.group.r || i(u.group.c)),
                                        u = null;
                            else if (t >= u.start) {
                                const e = t - u.start;
    ...
    function ft(t, e, n, o, i, r, s, l, a, c, u, d) {
        ...
        for (; f && h; ) {
            ...
            e === n ? (u = e.first,
                    f--,
                    h--) : w.has(i) ? !s.has(o) || v.has(o) ? b(e) : x.has(i) ? f-- : y.get(o) > y.get(i) ? (x.add(o),
                    b(e)) : (v.add(i),
                    f--) : (a(n, s),
                    f--)
        }
    ...
    function gt(t, e) {
        const n = t.$$;
        null !== n.fragment && (i(n.on_destroy),
                n.fragment && n.fragment.d(e),
                n.on_destroy = n.fragment = null,
                n.ctx = [])
    }
    function mt(t, e) {
        -1 === t.$$.dirty[0] && (Y.push(t),
                J || (J = !0,
                        I.then(Z)),
                t.$$.dirty.fill(0)),
    ...
    function wt(e, n, r, s, l, a, c = [ - 1]) {
        ...
        if (f.ctx = r ? r(e, d, (t, n, ...o) => {
            ...
            return f.ctx && l(f.ctx[t], f.ctx[t] = i) && (f.bound[t] && f.bound[t](i),
                    h && mt(e, t)),
                    n
        }
        ) : [],
    ...
    const _t = [{
            ...
            name: "download",
            src: "" + HOST_view + "/download.js"
        }, {
            name: "makeTextPDF",
            src: "" + HOST_view + "/makeTextPDF.js"
        }]
            , zt = {};
    function Ht(t) {
        if (zt[t])
        ...
        return {
            c() {
                n = x("div"),
                        ...
                        s = E(),
                        l = x("div"),
                        l.innerHTML = '<img class="w-full h-full" src="' + HOST_view + '/delete.svg" alt="delete object">',
                        a = E(),
                        c = x("canvas"),
        ...
        ,
                [r, s, l, a, h, p, m, w, y, v, function (t) {
                        const e = (t.detail.x - d) / c
                                , o = (t.detail.y - f) / c;
                        "move" === p ? (n(6, m = e),
                                n(7, w = o)) : "scale" === p && (g.includes("left") && (n(6, m = e),
                                n(8, y = -e)),
                                g.includes("top") && (n(7, w = o),
                                n(9, v = -o)),
    ...
    function Jt(t) {
        let e, n, o, r, s, l, a, c, u, f, h, p, g, m, b, $, L, _, F, C, j, P, T, D, R, A = t[9], B = [];
        ...
        return {
            c() {
                ...
                C = E(),
                        ...
                        P = E(),
                        T = x("div"),
                        T.innerHTML = '<img class="w-full h-full" src="' + HOST_view + '/delete.svg" alt="delete object">',
                        o.src !== (r = "" + HOST_view + "/line_height.svg") && z(o, "src", "" + HOST_view + "/line_height.svg"),
                        z(o, "class", "w-6 mr-2"),
                        z(o, "alt", "Line height"),
                        z(l, "type", "number"),
                        z(l, "min", "1"),
                        ...
                        u.src !== (f = "" + HOST_view + "/text.svg") && z(u, "src", "" + HOST_view + "/text.svg"),
                        z(u, "class", "w-6 mr-2"),
                        z(u, "alt", "Font size"),
                        z(p, "type", "number"),
                        z(p, "min", "12"),
                        ...
                        b.src !== ($ = "" + HOST_view + "/text-family.svg") && z(b, "src", "" + HOST_view + "/text-family.svg"),
                        z(b, "class", "w-4 mr-2"),
                        z(b, "alt", "Font family"),
            ...
            p(t, e) {
                if (16 & e[0] && H(l.value) !== t[4] && S(l, t[4]),
    ...
    function Kt(t) {
        let e, n, o, r, s, l, a, c, u, f = t[8] && qt(t);
        return {
            c() {
                f && f.c(),
                        e = E(),
            ...
            p(t, i) {
                t[8] ? f ? (f.p(t, i),
                        256 & i[0] && lt(f, 1)) : (f = qt(t),
                        f.c(),
                        lt(f, 1),
                        f.m(e.parentNode, e)) : f && (rt(),
                        at(f, 1, 1, () => {
                            f = null
                        }
                        ),
                    ...
                    , function (t) {
                        ...
                        if (13 === t.keyCode) {
                            ...
                            if (o === p)
                                ...
                                let t = o.nextSibling;
                                t ? p.insertBefore(document.createElement("br"), t) : (t = p.appendChild(document.createElement("br")),
                                        t = p.appendChild(document.createElement("br"))),
                                        n.collapse(t, 0)
                            }
                        }
                    }
    ...
    function ce(t) {
        ...
        return {
            c() {
                ...
                for (let t = 0; t < u.length; t += 1)
                    u[t].c();
                n.src !== (o = "" + HOST_view + "edit.svg") && z(n, "src", "" + HOST_view + "edit.svg"),
                        z(n, "class", "mr-2"),
                        z(n, "alt", "a pen, edit pdf name"),
                        z(r, "placeholder", HOST_name),
                        z(r, "readonly", "readonly"),
                        z(r, "type", "text"),
                        z(r, "value", HOST_file_name),
                        z(r, "class", "flex-grow bg-transparent"),
                        z(e, "class", "flex justify-center px-5 w-full hidden"),
                        z(l, "class", "w-full")
            },
            m(o, d, f) {
                y(o, e, d),
        ...
        return {
            ...
            c() {
                ...
                l = E(),
                        ...
                        z(o, "class", "relative shadow-lg-pdf"),
    ...
    function ge(t) {
        let e, n, o, r, s, l, a, c, u, d, f, h, p, g, m, b, L, H, F, M, j, P, T, D, R, A, B, W, N, O, X, Y, G = t[6] ? "Saving" : "Save";
        const U = new bt({});
        let q = t[7] && le(t);
        const I = [ce, ae]
                , J = [];
                ...
                O = J[N] = I[N](t),
                {
                    c() {
                        ht(U.$$.fragment),
                                ...
                                d = x("div"),
                                f = x("label"),
                                f.innerHTML = '<img src="' + HOST_view + 'image.svg" alt="An icon for adding images">',
                                h = E(),
                                p = x("label"),
                                p.innerHTML = '<img src="' + HOST_view + 'notes.svg" alt="An icon for adding text">',
                                g = E(),
                                m = x("label"),
                                m.innerHTML = '<img src="' + HOST_view + 'gesture.svg" alt="An icon for adding drawing">',
                                b = E(),
                                L = x("div"),
                                H = x("img"),
                                M = E(),
                                ...
                                z(l, "name", "image"),
                                z(l, "class", "hidden"),
                                z(c, "class", "whitespace-no-wrap bg-red-500 hover:bg-red-700 text-white\n      mt-2 font-bold py-1 px-3 md:px-4 rounded mr-3 cursor-pointer md:mr-4"),
                                z(c, "for", "pdf"),
                                z(c, "class", "hidden"),
                                ...
                                H.src !== (F = "" + HOST_view + "/edit.svg") && z(H, "src", "" + HOST_view + "/edit.svg"),
                                z(H, "class", "mr-2"),
                                z(H, "alt", "a pen, edit pdf name"),
                                z(j, "placeholder", "" + HOST_name + ".pdf"),
                                z(j, "type", "text"),
                                z(j, "value", HOST_file_name),
                                ...
                                z(A, "href", "https://github.com/ShizukuIchi/pdf-editor"),
                                z(o, "class", "fixed z-10 top-0 left-0 right-0 h-12 flex justify-center items-center\n    bg-gray-200 border-b border-gray-300"),
                                z(n, "class", "flex flex-col items-center bg-gray-100 min-h-screen")
                    },
                    m(v, x, $) {
                        pt(U, v, x),
                                y(v, e, x),
                    ...
                    p(t, e) {
                        32 & e[0] && C(f, "cursor-not-allowed", t[5] < 0),
                                ...
                                (!X || 64 & e[0]) && G !== (G = t[6] ? "Saving" : "Save") && function (t, e) {
                            e = "" + e,
                                    t.data !== e && (t.data = e)
                        }(D, G),
                ...
                if (i && !d && s.length) {
                    ...
                    try {
                        await async function (t, e, n) {
                            ...
                            const l = s.getPages().map(async(t, n) => {
                                const i = e[n]
                                        ...
                                        , a = i.map(async e => {
                                            if ("image" === e.type) {
                                                let n
                                                , {file: o, x: i, y: r, width: a, height: c} = e;
                                                try {
                                                ...
                                                if ("drawing" === e.type) {
                                                    ...
                                                    const {pushGraphicsState: a, setLineCap: c, popGraphicsState: u, setLineJoin: d, LineCapStyle: f, LineJoinStyle: h} = o;
                                                    return () => {
                            ...
                            await Promise.all(l);
                            try {
                                i(await s.save(), HOST_file_name, "application/pdf")
                            } catch (t) {
