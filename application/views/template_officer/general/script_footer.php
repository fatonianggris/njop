...
<script src="<?php echo base_url(); ?>assets/officer/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
<script src="<?php echo base_url(); ?>assets/officer/dist/assets/js/pages/features/calendar/basic.js"></script>
<script src="<?php echo base_url(); ?>assets/officer/dist/assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js"></script>
<!--end::Page Vendors-->
...
<script src="<?php echo base_url(); ?>assets/officer/dist/assets/js/pages/crud/file-upload/image-input-emp.js"></script>
<script src="<?php echo base_url(); ?>assets/officer/dist/assets/js/pages/widgets.js"></script>
<script src="<?php echo base_url(); ?>assets/officer/dist/assets/js/pages/custom/user/list-datatable.js"></script>
<script src="<?php echo base_url(); ?>assets/officer/dist/assets/js/pages/crud/forms/editors/ckeditor-classic.js"></script>
...
<script src="<?php echo base_url(); ?>assets/officer/dist/assets/js/pages/crud/forms/widgets/bootstrap-timepicker.js">
</script>
<script>
    $('.dropify').dropify({
        messages: {
