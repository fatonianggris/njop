...
/*
  ...
  |
 */
$config['base_url'] = 'http://localhost/njop/';
...
$config['csrf_exclude_uris'] = array(
    ...
    'admin/settings/account/check_email_akun',
    'admin/report/letter/check_laporan',
    'admin/report/export/export_data_csv',
   
    'client/register/check_laporan',
    
    'officer/settings/account/check_email_akun',
    'officer/report/check_laporan',
    'officer/auth/reset_password',
    'officer/register/edit_formulir/[0-9a-z]+',
);
/*
  |--------------------------------------------------------------------------
  | Output Compression
