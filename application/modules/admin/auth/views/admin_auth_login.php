...
<html lang="en">
    ...
    <head><base href="../../../../">
        <meta charset="utf-8" />
        <title>Login Keuangan | Sekolah Utsman</title>
        ...
        <link href="<?php echo base_url(); ?>assets/admin/dist/assets/css/pages/login/classic/login-4.css" rel="stylesheet" type="text/css" />
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
        ...
        <div class="d-flex flex-column flex-root">
            ...
            <div class="login login-4 login-signin-on d-flex flex-row-fluid" id="kt_login">
                <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('<?php echo base_url(); ?>assets/admin/dist/assets/media/bg/bg-2.jpg');">
                    <div class="login-form text-center p-7 position-relative overflow-hidden">
                        <!--begin::Login Header-->
                        <div class="d-flex flex-center mb-10">
                            <a href="#">
                                <img src="<?php echo base_url() . $page[0]->logo_website; ?>"  class="max-h-180px" alt="" />
                            </a>
                        </div>
                        <!--end::Login Header-->
                        ...
                        <div class="login-signin">
                            <div class="mb-10">
                                <h4 class="font-weight-bolder text-warning">Login Sistem NJOP</h4>
                                <h1 class="font-weight-bolder text-warning">Acitya Technology Project</h1>
                                <div class="text-danger font-weight-bold">Silahkan login sesuai email dan kata sandi anda:</div>
                            </div>
                            <?php echo $this->session->flashdata('flash_message'); ?>
                            <form class="form" novalidate="novalidate" method="POST" action="<?php echo base_url(); ?>admin/auth/login"  id="kt_login_signin_form_admin">
                                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                                <div class="form-group mb-5">
                                    <input class="form-control text-white h-auto form-control-solid  bg-white-o-50 border-0 py-5 px-8" type="email" placeholder="Inputkan Email Anda" name="email" autocomplete="off" />
                                </div>
                                <div class="form-group mb-10">
                                    <input class="form-control text-white h-auto form-control-solid  bg-white-o-50 border-0 py-5 px-8" type="password" placeholder="Inputkan Kata Sandi Anda" name="password" />
                                </div>
                                <!--begin::Action-->
                            ...
                            <div class="mt-8">
                                ...
                                <a href="" target="_blank" class="text-white text-hover-primary">Acitya Technology</a>
                            </div>
                        </div>
                        ...
                        <div class="login-forgot">
                            <div class="mb-10">
                                <h3 class="font-weight-bolder text-warning">Lupa Kata Sandi ?</h3>
                                <div class="text-muted font-weight-bold">Silahkan masukkan email anda untuk mereset kata sandi.</div>
                            </div>
                            <form class="form" id="kt_login_forgot_form">
                                <div class="form-group">
                                    <label class="font-size-h7 text-danger">*Email yang terdaftar sebelumnya.</label>
                                    <input id="email_reset" class="form-control text-white h-auto form-control-solid bg-white-o-50 border-0 py-5 px-8" type="text" placeholder="Inputkan Email Anda" name="email" autocomplete="off" />
                                </div>
                ...
                function act_reset_password() {
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            return $.ajax({
                                type: "post",
                                url: "<?php echo site_url("admin/auth/reset_password") ?>",
                                data: {email: email},
                                dataType: 'html',
        ...
        <script src="<?php echo base_url(); ?>assets/admin/dist/assets/js/pages/custom/login/login-admin.js"></script>
        <!--end::Page Scripts-->
    </body>
    <!--end::Body-->
</html>