            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom" id="kt_form" >
                        ...
                        <!--begin::Form-->
                        <form class="form" novalidate="novalidate" action="<?php echo site_url('admin/settings/settings/update_general_page'); ?>" enctype="multipart/form-data" method="post" id="kt_add_page_form">
