                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item text-muted">
                            <a href="" class="text-muted">Edit Akun Admin</a>
                        </li>                       
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="row">
                <div class="col-lg-12" id="kt_form" >
                    ...
                    <div class="card card-custom" >
                        ...
                        <!--begin::Form-->
                        <form class="form" novalidate="novalidate" action="<?php echo site_url('admin/settings/account/update_account/' . paramEncrypt($account[0]->id_akun)); ?>" enctype="multipart/form-data" method="post" id="kt_edit_account_form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <select name="role_akun" id="" class="form-control form-control-lg">
                                                <?php
                                                if (!empty($structure)) {
                                                    foreach ($structure as $key => $value) {
                                                        if ($value->id_struktur == $account[0]->role_akun) {
                                                            ?> 
                                                            <option value="<?php echo $value->id_struktur; ?>" selected=""><?php echo ucwords(strtolower($value->nama_struktur)); ?></option>
                                                        <?php } else {
                                                            ?>
...
<!--end::Content-->
<script src="<?php echo base_url(); ?>assets/admin/dist/assets/js/pages/custom/login/edit-account-admin.js"></script>
