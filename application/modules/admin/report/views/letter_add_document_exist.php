        ...
        <div class="container">
            ...
            <div class="alert alert-custom alert-light-warning shadow-sm fade show mb-7" role="alert">
                ...
                <div class="alert-text text-dark">
                    ...
                    <b>MOHON DIPERHATIKAN!</b>, Pengisian <b>OTOMATIS</b> Data Laporan NJOP dibawah ini menggunakan Data Laporan <b>TAHUN SEBELUMNYA</b>. Silahkan melakukan <b>PERUBAHAN</b> jika inputan <b>TIDAK SESUAI</b> dengan bukti laporan yang akan Anda inputkan sekarang. Terima Kasih.
                </div>
            ...
            <div class="row">
                <div class="col-lg-12" id="kt_form" >
                    ...
                    <div class="card card-custom" >
                        ...
                        <!--begin::Form-->
                        <form class="form" novalidate="novalidate" action="<?php echo site_url('admin/report/letter/post_letter_document_exist'); ?>" enctype="multipart/form-data" method="post" id="kt_add_letter_form">
                                    ...
                                    <div class="col-lg-6 border-right border-left">
                                        <div class="row mt-2">
                                            ...
                                            <div class="form-group col-lg-7 col-12">
                                                ...
                                                <textarea class="form-control" id="alamat_pemilik" placeholder="Isikan Nama Jalan/ Nomor Rumah" name="alamat_wajib_pajak" rows="2"><?php echo $letter[0]->alamat_wajib_pajak; ?></textarea>
