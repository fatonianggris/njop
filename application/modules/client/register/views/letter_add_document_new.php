<html lang="en">
    ...
    <body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="wizard wizard-2" id="kt_wizard" data-wizard-state="step-first" data-wizard-clickable="false">
                                            ...
                                            <div class="wizard-body py-5 px-5 py-lg-15 px-lg-15">
                                                ...
                                                <div class="row px-4">
                                                    <div class="col-lg-12">
                                                        <form class="form" method="POST" action="<?php echo site_url('/client/register/post_letter_document_new'); ?>" enctype="multipart/form-data"  id="kt_form_student">
        ...
        <script type="text/javascript">
            ...
            var url_prov = "<?php echo site_url('client/register/add_ajax_prov'); ?>/" + id_prov_pem;
            ...
            var url_kel = "<?php echo site_url('client/register/add_ajax_des_auto'); ?>/" + id_kec_pem + "/" + desa;
        ...
        <script>
            ...
            var url_kec = "<?php echo site_url('client/register/add_ajax_kec'); ?>/" + id_kab_ob;
