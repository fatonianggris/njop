<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url(); ?>assets/client/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(); ?>assets/client/dist/assets/css/pages/wizard/wizard-2.css" rel="stylesheet" type="text/css">
        ...
        <link href="<?php echo base_url(); ?>assets/client/dist/assets/css/pages/fonts/dropify.css" rel="stylesheet" type="text/css" />
    ...
    <body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
                ...
                <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('<?php echo base_url(); ?>assets/client/dist/assets/media/bg/bg-3.jpg');">
                    <div class="login-form p-7 position-relative overflow-hidden">
                        ...
                        <div class="mb-5 text-center">
                            <h1 class="font-mobile font-weight-boldest text-success ">Pengisian Formulir!</h1>
                        ...
                        <div class="d-flex flex-column flex-root">
                            ...
                            <div class="row">
                                ...
                                <div class="card card-custom bg-success-o-50 ">
                                    <div class="alert alert-custom alert-light-warning shadow-sm fade show mb-0" role="alert">
                                        <div class="alert-icon"><i class="flaticon-warning"></i></div>
                                        <div class="alert-text text-dark">
                                            <h4 class="alert-heading font-weight-bolder">Peringatan!</h4>
                                            <b>MOHON DIPERHATIKAN!</b>, Pengisian <b>OTOMATIS</b> Data Laporan NJOP dengan  dibawah ini menggunakan Data Laporan <b>TAHUN SEBELUMNYA</b>.<br> Silahkan melakukan <b>PERUBAHAN</b> jika inputan <b>TIDAK SESUAI</b> dengan bukti laporan yang akan Anda inputkan sekarang. Terima Kasih.
                                        </div>
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="wizard wizard-2" id="kt_wizard" data-wizard-state="step-first" data-wizard-clickable="false">
                                            ...
                                            <div class="wizard-body py-5 px-5 py-lg-15 px-lg-15">
                                                ...
                                                <div class="row px-4">
                                                    <div class="col-lg-12">
                                                        <form class="form" method="POST" action="<?php echo site_url('/client/register/post_letter_document_exist'); ?>" enctype="multipart/form-data"  id="kt_form_student">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group input-group-lg input-group-solid">
                                                                                <input type="text" name="nik_wajib_pajak" id="kt_input_nik" value="<?php echo $letter[0]->nik_wajib_pajak; ?>" class="form-control form-control-solid form-control-lg" placeholder="Inputkan NIK/NOPEL"/>
                                                                            </div>
                                                                ...
                                                                <div class="row">        
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group input-group-lg input-group-solid">
                                                                                <input type="text" name="tahun_pajak" readonly=""   value="<?php echo $tahun_pajak_ext; ?>" id="kt_datepicker_tahun" class="form-control form-control-solid form-control-lg" placeholder="Inputkan Tahun Pajak"  />
                                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-12">
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <div class="input-group input-group-lg input-group-solid">
                                                                                <textarea class="form-control" name="letak_objek_pajak" rows="2"><?php echo $letter[0]->letak_objek_pajak; ?></textarea>
                                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <div class="input-group input-group-lg input-group-solid">
                                                                                <textarea class="form-control" id="alamat_pemilik" name="alamat_wajib_pajak" rows="2"><?php echo $letter[0]->alamat_wajib_pajak; ?></textarea>
                                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" id="nama_pemilik" name="nama_wajib_pajak" value="<?php echo $letter[0]->nama_wajib_pajak; ?>" class="form-control  form-control-lg form-control-solid"  placeholder="Isikan Nama Pemilik"/>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group input-group-lg input-group-solid">
                                                                                <input type="text" name="luas_bumi" value="<?php echo $letter[0]->luas_bumi; ?>"  class="form-control form-control-lg form-control-solid " placeholder="Inputkan Luas Bumi"/>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group input-group-lg input-group-solid">
                                                                                <input type="text" name="luas_bangunan"  value="<?php echo $letter[0]->luas_bangunan; ?>" class="form-control form-control-solid form-control-lg" placeholder="Inputkan Luas Bangunan"/>
                                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group input-group-lg input-group-solid">
                                                                                <input type="text" name="kelas_bumi" value="<?php echo $letter[0]->kelas_bumi; ?>" class="form-control form-control-solid  form-control-lg"  placeholder="Inputkan Kelas Bumi"/>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group input-group-lg input-group-solid">
                                                                                <input type="text" name="kelas_bangunan" value="<?php echo $letter[0]->kelas_bangunan; ?>" class="form-control form-control-solid form-control-lg" placeholder="Inputkan Kelas Bangunan"/>
                                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-10">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group input-group-lg input-group-solid">
                                                                                <input type="text" name="total_pajak_bumi_bangunan"  value="<?php echo $letter[0]->total_pajak_bumi_bangunan; ?>" class="form-control form-control-solid  form-control-lg"  placeholder="Inputkan Pembayaran Pajak "/>
                                                                            </div>
                        ...
                        <div class="text-center">
                            <a href="<?php echo site_url('officer/dashboard'); ?>" type="button" class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4 mt-5"><li class="fa fa-home font-size-h4"></li> Kembali ke Menu</a>
        ...
        <!--end::Page Scripts-->
        <script src="<?php echo base_url(); ?>assets/client/dist/assets/js/pages/crud/forms/widgets/select2.js"></script>
        <script src="<?php echo base_url(); ?>assets/client/dist/assets/js/pages/custom/wizard/wizard-client.js"></script>
        <script src="<?php echo base_url(); ?>assets/client/dist/assets/js/pages/crud/forms/widgets/bootstrap-switch.js"></script>      
        ...
        <script src="<?php echo base_url(); ?>assets/client/dist/assets/js/pages/crud/forms/widgets/bootstrap-daterangepicker.js"></script>
        <script src="<?php echo base_url(); ?>assets/client/dist/assets/js/pages/crud/forms/widgets/bootstrap-maxlength.js"></script>
        <script src="<?php echo base_url(); ?>assets/client/dist/assets/plugins/custom/whatsappchat/whatsapp-chat-support.js"></script>
        <script src="<?php echo base_url(); ?>assets/client/dist/assets/js/dropify.js"></script>
        ...
        <script>
            ...
            var url_kab = "<?php echo site_url('client/register/add_ajax_kab'); ?>/" + id_prov_ob + "/" + id_kab_ob;
            $('#kabupaten_kota_ob').load(url_kab);
            var url_kec = "<?php echo site_url('client/register/add_ajax_kec'); ?>/" + id_kab_ob + "/" + id_kec_ob;
            $('#kecamatan_ob').load(url_kec);
            var url_kel = "<?php echo site_url('client/register/add_ajax_des'); ?>/" + id_kec_ob + "/" + id_des_ob;
            $('#kelurahan_desa_ob').load(url_kel);
            $("#provinsi_ob").change(function () {
            id_prov_ob = $(this).val();
            var url = "<?php echo site_url('client/register/add_ajax_kab'); ?>/" + id_prov_ob;
            $('#kabupaten_kota_ob').load(url);
            return false;
            });
            $("#kabupaten_kota_ob").change(function () {
            id_kab_ob = $(this).val();
            var url = "<?php echo site_url('client/register/add_ajax_kec'); ?>/" + id_kab_ob;
            $('#kecamatan_ob').load(url);
            return false;
            });
            $("#kecamatan_ob").change(function () {
            id_kec_ob = $(this).val()
                    var url = "<?php echo site_url('client/register/add_ajax_des'); ?>/" + id_kec_ob;
            ...
            var url_kab = "<?php echo site_url('client/register/add_ajax_kab'); ?>/" + id_prov_pem + "/" + id_kab_pem;
            $('#kabupaten_kota_pem').load(url_kab);
            var url_kec = "<?php echo site_url('client/register/add_ajax_kec'); ?>/" + id_kab_pem + "/" + id_kec_pem;
            $('#kecamatan_pem').load(url_kec);
            var url_kel = "<?php echo site_url('client/register/add_ajax_des'); ?>/" + id_kec_pem + "/" + id_des_pem;
            $('#kelurahan_desa_pem').load(url_kel);
            $("#provinsi_pem").change(function () {
            id_prov_pem = $(this).val();
            var url = "<?php echo site_url('client/register/add_ajax_kab'); ?>/" + id_prov_pem;
            $('#kabupaten_kota_pem').load(url);
            return false;
            });
            $("#kabupaten_kota_pem").change(function () {
            id_kab_pem = $(this).val();
            var url = "<?php echo site_url('client/register/add_ajax_kec'); ?>/" + id_kab_pem;
            $('#kecamatan_pem').load(url);
            return false;
            });
            $("#kecamatan_pem").change(function () {
            id_kec_pem = $(this).val()
                    var url = "<?php echo site_url('client/register/add_ajax_des'); ?>/" + id_kec_pem;
