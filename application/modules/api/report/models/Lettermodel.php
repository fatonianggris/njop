...
class LetterModel extends CI_Model {
    ...
    public function check_api_auth($api_key = '') {
    ...
    public function check_letter_duplicate($nop = '', $tahun = '') {
    ...
    public function check_letter_by_nop_year($nop = '', $tahun = '') {
        $this->db->select("s.*, 
        ...
        $this->db->where('s.tahun_pajak', $tahun);
    ...
    public function get_letter_document() {
        $this->db->select("s.*, 
                                DATE_FORMAT(s.inserted_at, '%d/%m/%Y') AS tgl_post,
                                DATE_FORMAT(s.updated_at, '%d/%m/%Y') AS tgl_update, 
    ...
    public function insert_letter_document($value = '') {
        $this->db->trans_begin();
    ...
    public function update_status_letter($id = '', $value = '', $ket = '') {
        $this->db->trans_begin();
