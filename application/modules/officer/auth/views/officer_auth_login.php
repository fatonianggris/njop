                ...
                <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('<?php echo base_url(); ?>assets/officer/dist/assets/media/bg/bg-3.jpg');">
                    <div class="login-form text-center p-7 position-relative overflow-hidden">
                        ...
                        <div class="login-signin">
                            <div class="mb-8">
                                <h4 class="font-weight-bolder">Login Petugas NJOP</h4>
                                <h1 class="font-weight-bolder text-warning">Acitya Technology</h1>
                                <div class="text-danger font-weight-bold">Silahkan login sesuai email dan kata sandi anda:</div>
                            </div>
                            <?php echo $this->session->flashdata('flash_message'); ?>
                            <form class="form" novalidate="novalidate" method="POST" action="<?php echo base_url(); ?>officer/auth/login"  id="kt_login_signin_form_officer">
                        ...
                        <div class="login-forgot">
                            ...
                            <form class="form" id="kt_login_forgot_form">
                                ...
                                <div class="form-group mb-10">
                                    ...
                                    <input class="form-control form-control-solid h-auto py-4 px-8" type="text" placeholder="Inputkan Email Anda" name="email" autocomplete="off" />
                                </div>
            ...
            function act_reset_password() {
                ...
                Swal.fire({
                    ...
                    preConfirm: () => {
                        return $.ajax({
                            type: "post",
                            url: "<?php echo site_url("officer/auth/reset_password") ?>",
                            data: {email: email},
                            dataType: 'html',
