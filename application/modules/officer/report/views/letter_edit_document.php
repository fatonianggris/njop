<html lang="en">
    ...
    <body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
                    ...
                    <div class="login-form p-7 position-relative overflow-hidden">
                        ...
                        <div class="d-flex flex-center mb-3">
                            <div class="text-center">
                                <h3 class="font-mobile display-4 text-warning font-weight-boldest">EDIT LAPORAN</h3>
                            </div>
                        </div>
                        <!--end::Login Header-->
                        ...
                        <div class="row flex-center ">
                            ...
                            <div class="card card-custom card-stretch bg-warning-o-50 mb-5">
                                <!--begin::Body-->
                                <div class="card-body d-flex align-items-center text-center py-0 mt-2">
                                    ...
                                    <span class=" text-dark-75 font-size-md">
                                            Berikut merupakan kolom formulir edit laporan, Silahakan mengedit Formulir Surat.
                                        </span>
                                    </div>
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="wizard wizard-2" id="kt_wizard" data-wizard-state="step-first" data-wizard-clickable="false">
                                            ...
                                            <div class="wizard-body py-5 px-5 py-lg-15 px-lg-15">
                                                ...
                                                <div class="row px-4">
                                                    <div class="col-lg-12">
                                                        <form class="form" method="POST" action="<?php echo site_url('/officer/report/update_letter_document/' . paramEncrypt($letter[0]->id_surat)); ?>" enctype="multipart/form-data"  id="kt_form_student">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group input-group-lg input-group-solid">
                                                                                <input type="text" id="kt_input_nop" name="nomor_nop" value="<?php echo $letter[0]->nomor_nop; ?>" class="form-control form-control-lg form-control-solid"  placeholder="Inputkan NOP Surat"/>
                                                                            </div>
                                                                ...
                                                                <div class="row">        
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group input-group-lg input-group-solid">
                                                                                <input type="text" name="tahun_pajak" readonly=""  value="<?php echo $letter[0]->tahun_pajak; ?>" id="kt_datepicker_tahun" class="form-control form-control-solid form-control-lg" placeholder="Inputkan Tahun Pajak"  />
                                                                            </div>
                                                                    ...
                                                                    <div class="col-lg-10">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <?php if ($letter[0]->status_pembayaran_pajak == 1) { ?>
                                                                                <input data-switch="true" type="checkbox" class="lunas font-weight-bold" checked value="1" name="status_pembayaran_pajak" data-size="large" data-on-text="LUNAS" data-off-text="BELUM" data-on-color="success" data-off-color="danger">
                                                                            <?php } else { ?>
                                                                                <input data-switch="true" type="checkbox" class="lunas font-weight-bold" value="0" name="status_pembayaran_pajak" data-size="large" data-on-text="LUNAS" data-off-text="BELUM" data-on-color="success" data-off-color="danger">
                                                                            <?php } ?>
                                                                ...
                                                                <div class="row ">  
                                                                    <div class="col-xl-12">
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <input type="file" class="dropify_pajak" name="foto_surat" data-default-file="<?php echo site_url($letter[0]->foto_surat); ?>" data-max-file-size="5M" data-height="120" data-allowed-file-extensions="png jpg jpeg" />
        ...
        <script src="<?php echo base_url(); ?>assets/officer/dist/assets/js/pages/custom/wizard/wizard-edit.js"></script>
        ...
        <script>
            $(document).ready(function () {
                ...
                var url_kec = "<?php echo site_url('officer/report/add_ajax_kec'); ?>/" + id_kab_ob + "/" + id_kec_ob;
                $('#kecamatan_ob').load(url_kec);
                var url_kel = "<?php echo site_url('officer/report/add_ajax_des'); ?>/" + id_kec_ob + "/" + id_des_ob;
                ...
                var url_kec = "<?php echo site_url('officer/report/add_ajax_kec'); ?>/" + id_kab_pem + "/" + id_kec_pem;
                $('#kecamatan_pem').load(url_kec);
                var url_kel = "<?php echo site_url('officer/report/add_ajax_des'); ?>/" + id_kec_pem + "/" + id_des_pem;
                $('#kelurahan_desa_pem').load(url_kel);
