<html lang="en">
    ...
    <body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
                    ...
                    <div class="login-form text-center p-7 position-relative overflow-hidden">
                        ...
                        <div class="d-flex flex-center mb-3">
                            <div class="text-center">
                                <h3 class="font-mobile display-4 text-warning font-weight-boldest">EDIT PROFILE</h3>
                            </div>
                        </div>
                        <!--end::Login Header-->
                            ...
                            <div class="card card-custom card-stretch bg-warning-o-50 mb-5 text-center">
                                ...
                                <div class="card-body d-flex align-items-center py-0 mt-2">
                                    ...
                                    <span class=" text-dark-75 font-size-md">
                                            Berikut merupakan halaman edit profile, silahkan edit biodata Anda.
                                        </span>
                                    </div>
                        ...
                        <div class="login-signin">
                            ...
                            <div class="row" id="kt_form">
                                ...
                                <div class="card card-custom" >
                                    <!--begin::Form-->
                                    <form class="form" novalidate="novalidate" action="<?php echo site_url('officer/settings/account/update_account_profile/'); ?>" enctype="multipart/form-data" method="post" id="kt_edit_profile_form">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label>API KEY</label>
                                                        <textarea class="form-control form-control-solid" placeholder="Isi api key" name="api_key" rows="3" readonly=""><?php echo $account[0]->api_key; ?></textarea>
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="form-group">
                                                        <label>Alamat</label>
                                                        <textarea class="form-control" placeholder="Isikan Alamat" name="alamat" rows="5"><?php echo $account[0]->alamat; ?></textarea>
        ...
        <script src="<?php echo base_url(); ?>assets/officer/dist/assets/js/pages/custom/login/edit-profile.js"></script>
        <!--end::Page Scripts-->
